...
?>
            ...
            <script type="text/javascript">
                ...
                var disqus_shortname = '<?php echo $smof_data['disqus_shortname'];?>'; // required: replace example with your forum shortname
...
?>
            ...
            <div id="comments" class="comm-wrapper">
                ...
                <div class="page-title clearfix">
                    <h3><?php comments_number(__('No Comment', 'ThemeStockyard'), __('One Comment', 'ThemeStockyard'), __('% Comments', 'ThemeStockyard') );?></h3>
                </div>
...
<?php 
    $comment_form = array( 
        'fields' => apply_filters('comment_form_default_fields', array(
            ...
            'logged_in_as' => '',
            'title_reply' => '<span>' . __('Leave a Reply', 'ThemeStockyard') . '</span>',
            'title_reply_to' => '<span>' . __('Leave a reply to:', 'ThemeStockyard') . '</span> <strong>%s</strong>',
