...
$ts_shortcodes['blog'] = array(
	...
	'params' => array(
		...
		'layout' => array(
			...
			'options' => array(
				...
				'2column' => __('2 Columns', 'ThemeStockyard'),
				'3column' => __('3 Columns', 'ThemeStockyard'),
				'cards' => __('Cards', 'ThemeStockyard'),
				'grid' => __('Grid/Masonry', 'ThemeStockyard'),
				'horizontal' => __('Horizontal Rows', 'ThemeStockyard'),
		...
		'show_pagination' => array(
			...
			'desc' => __('Set to &#8220;No&#8221; if you only want to show recent posts, with no page links', 'ThemeStockyard'),
			'options' => $choices,
			'std' => 'yes'
		),/*
	...
	'shortcode' => '[blog layout="{{layout}}" limit="{{posts_per_page}}" infinite_scroll="{{infinite_scroll}}" category_name="{{category_name}}" include="{{include}}" exclude="{{exclude}}" exclude_previous_posts="{{exclude_previous_posts}}" exclude_these_later="{{exclude_these_later}}" excerpt_length="{{excerpt_length}}" title_size="{{title_size}}" text_align="{{text_align}}" show_pagination="{{show_pagination}}" show_excerpt="{{show_excerpt}}" show_meta="{{show_meta}}" show_read_more="{{show_read_more}}" allow_videos="{{allow_videos}}" allow_galleries="{{allow_galleries}}"][/blog]',
...
$ts_shortcodes['blog_slider'] = array(
	...
	'params' => array(
		...
		'slider_type' => array(
			'type' => 'select',
			'label' => __( 'Slider Type', 'ThemeStockyard'),
			'options' => array(
				'flexslider' => __('Flexslider', 'ThemeStockyard'),
				'carousel' => __('Carousel', 'ThemeStockyard'),
			)
		),
		'limit' => array(
			'type' => 'select',
		...
		'show_excerpt' => array(
			'type' => 'radio_inline',
			'label' => __( 'Show Excerpt?', 'ThemeStockyard'),
			'desc' =>  __( 'Set to "no" if using this shortcode within a small column or within the sidebar.', 'ThemeStockyard'),
			'options' => $choices,
			'std' => 'yes'
		),
		'show_meta' => array(
		...
		'image_size' => array(
			'type' => 'select',
			'label' => __( 'Image size (Flexslider only)', 'ThemeStockyard'),
	...
	'shortcode' => '[blog_slider slider_type="{{slider_type}}" limit="{{limit}}" category_name="{{category_name}}" include="{{include}}" exclude="{{exclude}}" exclude_previous_posts="{{exclude_previous_posts}}" exclude_these_later="{{exclude_these_later}}" excerpt_length="{{excerpt_length}}" title_size="{{title_size}}" text_align="{{text_align}}" show_excerpt="{{show_excerpt}}" show_meta="{{show_meta}}" allow_videos="{{allow_videos}}" image_size="{{image_size}}"][/blog_slider]',
...
$ts_shortcodes['blog_widget'] = array(
	...
	'shortcode' => '[blog_widget widget_heading="{{widget_heading}}" widget_layout="{{widget_layout}}" limit="{{limit}}" category_name="{{category_name}}" override_widget_heading="{{override_widget_heading}}" include="{{include}}" exclude="{{exclude}}" exclude_previous_posts="{{exclude_previous_posts}}" exclude_these_later="{{exclude_these_later}}" excerpt_length="{{excerpt_length}}" title_size="{{title_size}}" text_align="{{text_align}}" show_excerpt="{{show_excerpt}}" show_meta="{{show_meta}}" show_media="{{show_media}}" allow_videos="{{allow_videos}}" allow_galleries="{{allow_galleries}}"][/blog_widget]',
...
$ts_shortcodes['carousel_gallery'] = array(
    'params' => array(
        /*
		'height' => array(
			'type' => 'text',
			'label' => __('Height', 'ThemeStockyard'),
			'desc' => __('Example: 340px', 'ThemeStockyard'),
			'std' => '340px'
		)
		*/
    ),
	'shortcode' => '[carousel_gallery]{{child_shortcode}}[/carousel_gallery]',
	'popup_title' => __('Carousel Gallery Shortcode', 'ThemeStockyard'),
	'no_preview' => true,
...
$ts_shortcodes['googlemap'] = array(
	...
	'params' => array(
		...
		/*'scale' => array(
			'type' => 'select',
			'label' => __('Show Scale Control on Map', 'ThemeStockyard'),
			'desc' => __('Display the map scale', 'ThemeStockyard'),
			'options' => $choices
		),
		'zoom_pancontrol' => array(
			'type' => 'select',
			'label' => __('Show Pan Control on Map', 'ThemeStockyard'),
			'desc' => __('Displays pan control button', 'ThemeStockyard'),
			'options' => $choices
		),*/
		'hue' => array(
            'std' => '',
            'type' => 'colorpicker',
            'label' => __('Color Hue', 'ThemeStockyard')
		),
	),
	'shortcode' => '[map address="{{content}}" height="{{height}}" zoom="{{zoom}}" scrollwheel="{{scrollwheel}}" hue="{{hue}}"][/map]',
...
$ts_shortcodes['lightbox_gallery'] = array(
	...
	'shortcode' => '[lightbox_gallery hover_zoom="{{hover_zoom}}" columns="{{columns}}"]{{child_shortcode}}[/lightbox_gallery]',
...
$ts_shortcodes['list'] = array(
	...
	'shortcode' => '[list icon="{{icon}}" icon_color="{{icon_color}}"]&lt;ul&gt;{{child_shortcode}}&lt;/ul&gt;[/list]',
...
$ts_shortcodes['person'] = array(
	'no_preview' => true,
	'params' => array(

		'picture' => array(
			'type' => 'uploader',
			'label' => __('Picture', 'ThemeStockyard'),
			'desc' => __('Upload an image to display', 'ThemeStockyard')
		),
		'pic_link' => array(
			'std' => '',
			'type' => 'text',
			'label' => __('Picture Link URL', 'ThemeStockyard'),
			'desc' => __('Add the URL the picture will link to, ex: http://example.com', 'ThemeStockyard')
		),
		'name' => array(
			'std' => '',
			'type' => 'text',
		...
		'title' => array(
			...
			'type' => 'text',
			'label' => __('Title', 'ThemeStockyard'),
			'desc' => __('Insert the title of the person', 'ThemeStockyard')
		),
		'email' => array(
			'std' => '',
			'type' => 'text',
			'label' => __('Email Address', 'ThemeStockyard'),
			'desc' => __('Insert an email address to display the email icon', 'ThemeStockyard')
		),
		'facebook' => array(
			'std' => '',
			'type' => 'text',
			'label' => __('Facebook Profile Link', 'ThemeStockyard'),
			'desc' => __('Insert a url to display the facebook icon', 'ThemeStockyard')
		),
		'twitter' => array(
			'std' => '',
			'type' => 'text',
			'label' => __('Twitter Profile Link', 'ThemeStockyard'),
			'desc' => __('Insert a url to display the twitter icon', 'ThemeStockyard')
		),
		'linkedin' => array(
			'std' => '',
			'type' => 'text',
			'label' => __('LinkedIn Profile Link', 'ThemeStockyard'),
			'desc' => __('Insert a url to display the linkedin icon', 'ThemeStockyard')
		),
		'dribbble' => array(
			'std' => '',
			'type' => 'text',
			'label' => __('Dribbble Profile Link', 'ThemeStockyard'),
			'desc' => __('Insert a url to display the dribbble icon', 'ThemeStockyard')
		),
        'target' => array(
            'type' => 'select',
            'label' => __('Link Target', 'ThemeStockyard'),
		...
		'content' => array(
			'std' => '',
			'type' => 'textarea',
			'label' => __('Profile Description', 'ThemeStockyard'),
			'desc' => __('Enter the content to be displayed', 'ThemeStockyard')
		),
	),
	...
	'popup_title' => __( 'Person Shortcode', 'ThemeStockyard')
);
...
$ts_shortcodes['portfolio'] = array(
	...
	'params' => array(
		...
		'layout' => array(
			...
			'options' => array(
				...
				'5column' => __('5 Column', 'ThemeStockyard'),
				'cards' => __('Cards', 'ThemeStockyard'),
				'grid' => __('Grid', 'ThemeStockyard'),
			)
		),
		'posts_per_page' => array(
			'type' => 'select',
	...
	'shortcode' => '[portfolio layout="{{layout}}" limit="{{posts_per_page}}" show_pagination="{{show_pagination}}" show_filter="{{show_filter}}" align_filter="{{align_filter}}" include="{{include}}" exclude="{{exclude}}" category_name="{{category_name}}"][/portfolio]',
...
$ts_shortcodes['social_links'] = array(
	...
	'params' => array(
		...
		'style' => array(
			'type' => 'select',
			'label' => __('Style', 'ThemeStockyard'),
			'desc' => __('Choose the style for the social links', 'ThemeStockyard'),
			'options' => array(
				'fontawesome' => __('FontAwesome Icons', 'ThemeStockyard'),
				'image' => __('Image Icons', 'ThemeStockyard')
			)
		),
		'size' => array(
			'std' => '',
...
$ts_shortcodes['tabs'] = array(
	'params' => array(
		...
		'style' => array(
			'type' => 'select',
			'label' => __('Style', 'ThemeStockyard'),
			'desc' => __('Choose between &#8220;Simple&#8221; and &#8220;Traditional&#8221;', 'ThemeStockyard'),
			'options' => array(
				'simple' => __('Simple', 'ThemeStockyard'),
				'traditional' => __('Traditional', 'ThemeStockyard')
			)
		),
		'layout' => array(
	...
	'no_preview' => true,
	'shortcode' => '[tabs style="{{style}}" layout="{{layout}}"]&lt;br /&gt;{{child_shortcode}}&lt;br /&gt;[/tabs]',
...
$ts_shortcodes['title'] = array(
	...
	'params' => array(
		...
		'style' => array(
			...
			'options' => array(
                ...
                'single' => __('Single Line', 'ThemeStockyard'),
                'dashed' => __('Dashed Line', 'ThemeStockyard'),
                'double' => __('Double Line', 'ThemeStockyard'),
                'double-dashed' => __('Double Dashed', 'ThemeStockyard'),
			)
		),
		'border_color' => array(
            'type' => 'colorpicker',
	...
	'shortcode' => '[title size="{{size}}" color="{{color}}" style="{{style}}" border_color="{{border_color}}" padding_top="{{padding_top}}" padding_bottom="{{padding_bottom}}"]{{content}}[/title]',
