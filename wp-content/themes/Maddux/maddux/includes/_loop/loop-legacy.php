...
?>
                <div class="loop-wrap loop-legacy-wrap">
                    <div class="entries blog-entries loop-legacy loop <?php echo esc_attr($entries_class);?>">
                        <?php
                        ...
                        ?>                        
                        <div id="post-<?php echo esc_attr($ts_query->post->ID);?>" class="entry clearfix">
