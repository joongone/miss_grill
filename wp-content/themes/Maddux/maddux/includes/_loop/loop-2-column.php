...
?>
                <div class="loop-wrap loop-2-column-wrap">
                    <div class="entries loop blog-entries loop-2-column <?php echo esc_attr($entries_class);?> clearfix">
                        <?php
                        ...
                        <div id="post-<?php echo esc_attr($ts_query->post->ID);?>" class="entry span6">
                            <div class="entry-content">
                                <?php
                                if($ts_show->media) :
                                    $allow_vids = (isset($atts['allow_videos'])) ? $atts['allow_videos'] : '';
                                    $allow_gals = (isset($atts['allow_galleries'])) ? $atts['allow_galleries'] : '';
                                    echo ts_get_featured_media(array('media_width'=>520,'media_height'=>293,'allow_videos'=>$allow_vids,'allow_galleries'=>$allow_gals));
                                endif;
                                ?>   
