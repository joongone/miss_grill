...
?>
                <div class="loop-wrap loop-masonry-wrap">
                    <div class="entries blog-entries loop loop-masonry <?php echo esc_attr($entries_class);?> clearfix">
                        <?php
                            ...
                            <div class="entry-content">
                                ...
                                <div class="title-date clearfix">
                                    <div class="title-info">                                    
                                        <h<?php echo absint($title_size->h).' '.$title_size->style;?> class="title-h <?php echo esc_attr($text_align);?>"><?php echo ts_sticky_badge();?><a href="<?php the_permalink();?>"><?php the_title();?></a></h<?php echo esc_attr($title_size->h);?>>
                                        <?php 
                                        if($ts_show->meta) :
