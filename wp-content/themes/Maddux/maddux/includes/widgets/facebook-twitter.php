...
class ts_facebook_twitter_widget extends WP_Widget {
	...
	function widget($args, $instance) 
	{
        ...
        if($facebook) :
            $data = wp_remote_get('https://graph.facebook.com/'.urlencode($facebook).'/');
            if(isset($data['body'])) :
                ...
                if(isset($data->likes)) :
                    ...
                    echo '<h4 class="sp1" title="'.esc_attr($data->likes).'">'.ts_num2str($data->likes).'</h4>';
        ...
        if($twitter && (is_array($last_twitter_reponse))) :
            ...
            if(isset($data['followers_count'])) :
                ...
                echo '<h4 class="sp1" title="'.esc_attr($data['followers_count']).'">'.ts_num2str($data['followers_count']).'</h4>';
	...
	function form($instance) {        
        ...
        <p>
            <label for="<?php echo $this->get_field_id('facebook'); ?>"><?php _e('Facebook Page Username/ID:', 'ThemeStockyard'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('twitter'); ?>"><?php _e('Twitter Username:', 'ThemeStockyard'); ?></label>
...
register_widget('ts_facebook_twitter_widget');